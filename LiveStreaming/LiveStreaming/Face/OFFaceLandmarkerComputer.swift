...
/// 处理图中的人脸关键点节点。
class OFFaceLandmarkerComputer: NSObject, OFProcessNode {
    /// 美颜或网格预览打开时才送帧
    var isEnabled: Bool {
    ...
    func applyDebugOverlayIfNeeded(_ frame: VideoFrame) {
        if overlayEnabled {
