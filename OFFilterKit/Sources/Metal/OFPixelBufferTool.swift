...
/// PixelBuffer 池，避免每帧 malloc。由 OFFilterContext 持有实例。
public class OFPixelBufferTool: NSObject {
    ...
    /// 池中至少保留的 buffer 数量
    public let minimumBufferCount: UInt32 = 3
    ...
    public func update(width: UInt32, height: UInt32, pixelFormat: OSType) {
    ...
    ///   - height: 高
    ///   - pixelFormat: pixel 类型
    public func createPixelBufferPool(width: UInt32, height: UInt32, pixelFormat: OSType) {
