...
/// 单通道 / 灰度处理节点。
public class OFSingleColorMetalComputer: NSObject, OFProcessNode {
    /// 与 Metal kernel assistTools 的 type 参数对应
    public enum SingleColorType: Int {
        /// 关闭，透传
        case none = 0
        /// 只保留红色通道
        case red
    ...
    public var colorType: SingleColorType = .none {
        didSet {
    ...
    public var colorTypeBuffer: MTLBuffer?
